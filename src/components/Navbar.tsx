    ...
    <>
      <style>{`
        ...
        .nb-link.active::after {
          ...
          background: var(--color-accent, #cc1f1f);
          content: "";
        ...
        .nb-cta {
          ...
          outline: none;
          background: var(--color-accent, #cc1f1f);
          box-shadow: 0 2px 8px oklch(from var(--color-accent, #cc1f1f) l c h / .3);
          color: #fff;
          font-size: var(--text-sm);
          font-weight: 700;
          text-decoration: none;
        ...
        .nb-cta:hover {
          ...
          box-shadow: 0 4px 16px oklch(from var(--color-accent, #cc1f1f) l c h / .4);
        ...
        .nb-overlay {
          ...
          animation: nb-overlay-in .2s ease;
        }

        @keyframes nb-drawer-in {
          from {
            opacity: .5;
        ...
        .nb-drawer {
          ...
          box-shadow: -12px 0 40px oklch(0 0 0 / .15);
          animation: nb-drawer-in .28s cubic-bezier(.16,1,.3,1);
        }
        ...
        .nb-mobile-link.active {
          border-color: oklch(from var(--color-accent, #cc1f1f) l c h / .3);
          background: oklch(from var(--color-accent, #cc1f1f) l c h / .08);
          color: var(--color-accent, #cc1f1f);
          font-weight: 600;
        }
      ...
      <header className={`nb ${scrolled ? "scrolled" : "top"}`}>
        <div className="nb-inner">
          <Link
            href="/"
            className="nb-logo"
            aria-label="AirShow — strona główna"
          >
            <svg
              width="32"
              height="32"
            ...
            <span className="nb-logo-text">
              Air
              <span style={{ color: "var(--color-accent,#cc1f1f)" }}>
                Show
              </span>
            </span>
          </Link>
      ...
      {menuOpen && (
        <>
          ...
          >
            ...
            <nav className="nb-drawer-body" aria-label="Menu mobilne">
              {NAV_LINKS.map((link) => (
                <Link
                  key={link.href}
                  href={link.href}
                  ...
                  onClick={() => setMenuOpen(false)}
                >
                  <span className="nb-mobile-dot" aria-hidden="true" />
                  {link.label}
                </Link>
              ))}
            </nav>
