...
export const metadata: Metadata = {
  ...
  openGraph: { type: "website", url: `${SITE_URL}/newsletter`, title: "AirShow Alert – nie przegap kolejnego Air Show", description: "Pokazy, aktualizacje i nowe galerie. Bez spamu, bez zbędnych wiadomości.", siteName: "AirShow Gallery", locale: "pl_PL" },
};
  ...
  return (
    <main className="nl-page">
      <style>{`
        ...
        .nl-benefits{display:grid;grid-template-columns:repeat(3,1fr);gap:14px}.nl-benefit{position:relative;padding:25px;border:1px solid var(--color-border);border-radius:17px;background:var(--color-surface);transition:transform .2s,border-color .2s,box-shadow .2s}.nl-benefit:hover{transform:translateY(-3px);border-color:var(--color-accent);box-shadow:var(--shadow-sm)}.nl-icon{display:grid;place-items:center;width:38px;height:38px;margin-bottom:17px;border-radius:11px;background:var(--color-surface-offset);color:var(--color-accent)}.nl-benefit h3{margin:0 0 7px;font-family:var(--font-display);font-size:17px;font-weight:800;letter-spacing:-.025em}.nl-benefit p{margin:0;color:var(--color-text-muted);font-size:13px;line-height:1.62}
        .nl-editorial{display:grid;grid-template-columns:.8fr 1.2fr;gap:clamp(35px,8vw,100px);align-items:start}.nl-editorial-note{padding-left:22px;border-left:3px solid var(--color-accent)}.nl-editorial-note p{margin:0;color:var(--color-text-muted);font-size:14px;line-height:1.8}.nl-preview{border:1px solid var(--color-border);border-radius:18px;overflow:hidden;background:var(--color-surface);box-shadow:var(--shadow-lg)}.nl-preview-head{display:flex;align-items:center;justify-content:space-between;padding:16px 20px;border-bottom:1px solid var(--color-divider);font-size:11px;font-weight:800;letter-spacing:.08em}.nl-preview-tag{color:var(--color-accent)}.nl-preview-body{padding:20px}.nl-preview-photo{height:210px;border-radius:12px;background:linear-gradient(145deg,var(--color-surface-offset),var(--color-bg));display:grid;place-items:center;color:var(--color-text-faint);font-size:10px;font-weight:800;letter-spacing:.12em;text-transform:uppercase;position:relative;overflow:hidden}.nl-preview-photo:after{content:"✈";font-size:62px;opacity:.12;transform:rotate(-12deg)}.nl-preview-photo span{display:none}.nl-preview h3{margin:18px 0 7px;font-family:var(--font-display);font-size:24px;line-height:1.05;letter-spacing:-.04em}.nl-preview p{margin:0;color:var(--color-text-muted);font-size:12px;line-height:1.65}.nl-preview-cta{display:inline-flex;align-items:center;gap:6px;margin-top:16px;color:var(--color-accent);font-size:10px;font-weight:800;letter-spacing:.08em;text-transform:uppercase}
        .nl-faq-wrap{max-width:850px}.nl-faq{display:grid;gap:8px}.nl-faq details{border:1px solid var(--color-border);border-radius:12px;background:var(--color-surface);overflow:hidden;transition:border-color .2s}.nl-faq details:hover{border-color:var(--color-text-faint)}.nl-faq summary{display:flex;align-items:center;justify-content:space-between;gap:20px;padding:19px 20px;cursor:pointer;list-style:none;font-size:14px;font-weight:700}.nl-faq summary::-webkit-details-marker{display:none}.nl-faq summary svg{flex-shrink:0;color:var(--color-text-faint);transition:transform .2s}.nl-faq details[open]{border-color:var(--color-accent)}.nl-faq details[open] summary svg{transform:rotate(180deg);color:var(--color-accent)}.nl-faq p{max-width:760px;margin:0;padding:0 20px 20px;color:var(--color-text-muted);font-size:13px;line-height:1.7}
        ...
        @media(max-width:900px){.nl-hero-grid,.nl-editorial{grid-template-columns:1fr}.nl-form-card{max-width:620px}.nl-benefits{grid-template-columns:repeat(2,1fr)}}@media(max-width:560px){.nl-container{width:min(100% - 28px,1120px)}.nl-hero{padding-top:52px}.nl-hero:before{font-size:5rem}.nl-benefits{grid-template-columns:1fr}.nl-form-card{padding:22px;border-radius:18px}.nl-title{font-size:clamp(2.9rem,15vw,4.3rem)}.nl-preview-photo{height:170px}.nl-faq summary{padding:17px 16px}.nl-faq p{padding:0 16px 17px}}
      `}</style>
      ...
      <section className="nl-hero">
        <div className="nl-container nl-hero-grid">
          ...
          <div className="nl-form-card">
            ...
            <p className="nl-form-sub">Kilka sekund i jesteś na pokładzie.</p>
            <NewsletterForm />
          </div>
        </div>
      </section>
      ...
      <section className="nl-section"><div className="nl-container nl-editorial"><div><div className="nl-kicker">Jak to wygląda?</div><h2 className="nl-h2">Krótko, konkretnie, z dużą ilością fotografii.</h2><div className="nl-editorial-note"><p>Nie chcemy tworzyć kolejnego maila, którego po kilku tygodniach zaczniesz ignorować. AirShow Alert będzie spokojnym, selektywnym dodatkiem do AirShow Gallery — z najważniejszymi rzeczami na pierwszym miejscu.</p></div></div><div className="nl-preview"><div className="nl-preview-head"><span>AIRSHOW ALERT</span><span className="nl-preview-tag">WYDANIE #04</span></div><div className="nl-preview-body"><div className="nl-preview-photo" aria-label="Podgląd wiadomości AirShow Alert"/><h3>5 pokazów, które warto mieć w kalendarzu</h3><p>🇵🇱 Polska · 🇨🇿 Czechy · 🇩🇪 Niemcy<br/><br/>📸 Zdjęcie miesiąca &nbsp; · &nbsp; 🔔 Ważna aktualizacja &nbsp; · &nbsp; 🛩️ Ciekawostka</p><span className="nl-preview-cta">Zobacz na AirShow Gallery <ArrowRight size={13}/></span></div></div></div></section>
